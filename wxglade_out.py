...
#
import Event_handlers as EvtHandler
import re
import wx
from wx.lib.pubsub import pub
from wx.lib.embeddedimage import PyEmbeddedImage
import icon_embedded
...
class MainFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.fucn_intr_ph_dl_text = wx.TextCtrl(self.function_index_page, wx.ID_ANY, _(
            u"\u529f\u80fd\u4ecb\u7ecd\uff1a\u901a\u8fc7\u9a8c\u8bc1\u672c\u6240\u7684\u5bc6\u7801\uff0c\u4ece\u4e91\u7aef\u50a8\u5b58\u670d\u52a1\u5668\u4e2d\u4e0b\u8f7d\u672c\u6240\u7684\u4f01\u4e1a\u73b0\u573a\u6838\u67e5\u7167\u7247\u5230\u6307\u5b9a\u7684\u6587\u4ef6\u5939\u4e2d\u3002\uff08\u9700\u8981\u8fde\u63a5\u5916\u7f51\uff09"),
                                                style=wx.TE_MULTILINE | wx.TE_READONLY)
        self.func_into_ph_dl_btn = wx.Button(self.function_index_page, wx.ID_ANY,
                                             _(u"\u7b2c\u4e00\u6b65\uff1a\u4e91\u7aef\u7167\u7247\u4e0b\u8f7d"),
                                             style=wx.BORDER_NONE)
        self.fucn_intr_ph_dl_text_copy = wx.TextCtrl(self.function_index_page, wx.ID_ANY, _(
            u"\u529f\u80fd\u4ecb\u7ecd:\u901a\u8fc7\u9a8c\u8bc1\u672c\u6240\u7684\u5bc6\u7801\uff0c\u4ece\u4e91\u7aef\u50a8\u5b58\u670d\u52a1\u5668\u4e2d\u4e0b\u8f7d\u672c\u6240\u7279\u5b9a\u4e13\u9879\u6838\u67e5\u884c\u52a8\u7684\u6838\u67e5\u8bb0\u5f55\u8868\u5230\u6307\u5b9a\u7684\u6587\u4ef6\u5939\u4e2d\u3002\uff08\u9700\u8981\u8fde\u63a5\u5916\u7f51\uff09"),
                                                     style=wx.TE_MULTILINE | wx.TE_READONLY)
        self.func_into_doc_gen_btn = wx.Button(self.function_index_page, wx.ID_ANY,
                                               _(u"\u7b2c\u4e8c\u6b65\uff1a\u6838\u67e5\u8bb0\u5f55\u4e0b\u8f7d"),
                                               style=wx.BORDER_NONE)
        self.fucn_intr_ph_dl_text_copy_copy = wx.TextCtrl(self.function_index_page, wx.ID_ANY, _(
            u"\u529f\u80fd\u4ecb\u7ecd:\u7ed3\u5408\u6838\u67e5\u7167\u7247\u4e0e\u4f01\u4e1a\u4fe1\u606f\u53ca\u6838\u67e5\u8bb0\u5f55\u8868\uff0c\u6279\u91cf\u751f\u6210\u5bf9\u5e94\u7684\u6838\u67e5\u6587\u4e66\u3002\uff08\u65e0\u9700\u8054\u7f51\uff09"),
                                                          style=wx.TE_MULTILINE | wx.TE_READONLY)
        self.func_into_doc_gen_btn_copy = wx.Button(self.function_index_page, wx.ID_ANY,
                                                    _(u"\u7b2c\u4e09\u6b65\uff1a\u6838\u67e5\u6587\u4e66\u751f\u6210"),
                                                    style=wx.BORDER_NONE)
        self.photo_download_page = wx.Panel(self.Entrance, wx.ID_ANY)
        self.rbox_division = wx.RadioBox(self.photo_download_page, wx.ID_ANY, _(u"\u9009\u62e9\u76d1\u7ba1\u6240"),
                                         choices=[_(u"\u72ee\u5cad"), _(u"\u8299\u84c9"), _(u"\u65b0\u534e"),
                                                  _(u"\u88d5\u534e"), _(u"\u82b1\u57ce"), _(u"\u65b0\u96c5"),
                                                  _(u"\u79c0\u5168"), _(u"\u82b1\u5c71"), _(u"\u82b1\u4e1c"),
                                                  _(u"\u70ad\u6b65"), _(u"\u8d64\u576d"), _(u"\u82b1\u4e1c"),
                                                  _(u"\u68af\u9762")], majorDimension=1, style=wx.RA_SPECIFY_COLS)
        self.photo_download_result_text = wx.TextCtrl(self.photo_download_page, wx.ID_ANY, "",
        ...
        self.doc_gen_ins_tpl_path = wx.TextCtrl(self.doc_gen_page, wx.ID_ANY, "",
                                                style=wx.TE_LEFT | wx.TE_MULTILINE | wx.TE_WORDWRAP)
        self.doc_gen_ph_tpl_path = wx.TextCtrl(self.doc_gen_page, wx.ID_ANY, "",
                                               style=wx.TE_LEFT | wx.TE_MULTILINE | wx.TE_WORDWRAP)
        self.doc_gen_xlsx_path = wx.TextCtrl(self.doc_gen_page, wx.ID_ANY, "",
                                             style=wx.TE_LEFT | wx.TE_MULTILINE | wx.TE_WORDWRAP)
        self.doc_gen_corp_photos_path = wx.TextCtrl(self.doc_gen_page, wx.ID_ANY, "",
                                                    style=wx.TE_LEFT | wx.TE_MULTILINE | wx.TE_WORDWRAP)
        self.doc_gen_path = wx.TextCtrl(self.doc_gen_page, wx.ID_ANY, "",
                                        style=wx.TE_LEFT | wx.TE_MULTILINE | wx.TE_WORDWRAP)
        self.doc_gen_choose_inspect_tpl = wx.Button(self.doc_gen_page, wx.ID_ANY,
                                                    _(u"\u9009\u7b14\u5f55\u6a21\u677f\n"), style=wx.BU_AUTODRAW)
        self.doc_gen_choose_photo_tpl = wx.Button(self.doc_gen_page, wx.ID_ANY, _(u"\u9009\u7167\u7247\u6a21\u677f\n"),
                                                  style=wx.BU_AUTODRAW)
        self.doc_gen_choose_inspect_xlsx = wx.Button(self.doc_gen_page, wx.ID_ANY,
                                                     _(u"\u9009\u62e9\u6838\u67e5\u8868\n"), style=wx.BU_AUTODRAW)
        self.doc_gen_choose_corp_photos_path = wx.Button(self.doc_gen_page, wx.ID_ANY,
                                                         _(u"\u9009\u7167\u7247\u76ee\u5f55\n"), style=wx.BU_AUTODRAW)
        self.label_ins_tpl = wx.StaticText(self.doc_gen_page, wx.ID_ANY, _(
            u"\u5df2\u7ecf\u6307\u5b9a\u683c\u5f0f\u4e3aDOCX\u7684\u73b0\u573a\u7b14\u5f55\u6a21\u677f\n"),
                                           style=wx.ALIGN_CENTER)
        self.label_ph_tpl = wx.StaticText(self.doc_gen_page, wx.ID_ANY, _(
            u"\u5df2\u7ecf\u6307\u5b9a\u683c\u5f0f\u4e3aDOCX\u7684\u8bc1\u636e\u63d0\u53d6\u5355\u6a21\u677f\n"),
                                          style=wx.ALIGN_CENTER)
        self.label_xlsx = wx.StaticText(self.doc_gen_page, wx.ID_ANY, _(
            u"\u5df2\u7ecf\u6307\u5b9a\u683c\u5f0f\u4e3aXLSX\u7684\u4f01\u4e1a\u4fe1\u606f\u53ca\u6838\u67e5\u8bb0\u5f55\u8868\n"),
                                        style=wx.ALIGN_CENTER)
        self.doc_gen_result_text_area = wx.TextCtrl(self.doc_gen_page, wx.ID_ANY, "",
                                                    style=wx.TE_MULTILINE | wx.TE_READONLY | wx.TE_WORDWRAP)
        self.doc_gen_preview = wx.Button(self.doc_gen_page, wx.ID_ANY, _(u"\u751f\u6210\u4e00\u6237\u9884\u89c8"),
                                         style=wx.BU_AUTODRAW)
        self.doc_gen_choose_path = wx.Button(self.doc_gen_page, wx.ID_ANY, _(u"\u66f4\u6539\u751f\u6210\u8def\u5f84\n"),
                                             style=wx.BU_AUTODRAW)
        self.doc_gen_begin = wx.Button(self.doc_gen_page, wx.ID_ANY, _(u"\u5f00\u59cb\u751f\u6210"),
                                       style=wx.BU_AUTODRAW)
        self.doc_gen_stop = wx.Button(self.doc_gen_page, wx.ID_ANY, _(u"\n\u4e2d\u6b62\u751f\u6210\n"),
                                      style=wx.BU_AUTODRAW)
        self.Entrance_ = wx.Panel(self.Entrance, wx.ID_ANY)

        self.__set_properties()
        self.__do_layout()

        self.Bind(wx.EVT_BUTTON, self.func_goto_ph_dl_btn, self.func_into_ph_dl_btn)
        self.Bind(wx.EVT_BUTTON, self.func_goto_ins_dl_btn, self.func_into_doc_gen_btn)
        self.Bind(wx.EVT_BUTTON, self.func_goto_doc_gen_btn, self.func_into_doc_gen_btn_copy)
    ...
    def __set_properties(self):
        ...
        self.fucn_intr_ph_dl_text.SetMinSize((800, 45))
        self.fucn_intr_ph_dl_text.SetFont(wx.Font(14, wx.MODERN, wx.NORMAL, wx.NORMAL, 0, "楷体_GB2312"))
        self.func_into_ph_dl_btn.SetMinSize((800, 85))
        self.func_into_ph_dl_btn.SetFont(wx.Font(20, wx.MODERN, wx.NORMAL, wx.BOLD, 0, "仿宋_GB2312"))
        self.fucn_intr_ph_dl_text_copy.SetMinSize((800, 45))
        self.fucn_intr_ph_dl_text_copy.SetFont(wx.Font(14, wx.MODERN, wx.NORMAL, wx.NORMAL, 0, "楷体_GB2312"))
        self.func_into_doc_gen_btn.SetMinSize((800, 85))
        self.func_into_doc_gen_btn.SetFont(wx.Font(20, wx.MODERN, wx.NORMAL, wx.BOLD, 0, "仿宋_GB2312"))
        self.fucn_intr_ph_dl_text_copy_copy.SetMinSize((800, 45))
        self.fucn_intr_ph_dl_text_copy_copy.SetFont(wx.Font(14, wx.MODERN, wx.NORMAL, wx.NORMAL, 0, "楷体_GB2312"))
        self.func_into_doc_gen_btn_copy.SetMinSize((800, 85))
        self.func_into_doc_gen_btn_copy.SetFont(wx.Font(20, wx.MODERN, wx.NORMAL, wx.BOLD, 0, "仿宋_GB2312"))
    ...
    def __do_layout(self):
        ...
        doc_gen_root_sizer = wx.StaticBoxSizer(
            wx.StaticBox(self.doc_gen_page, wx.ID_ANY, _(u"\u6587\u4e66\u751f\u6210\u5668")), wx.HORIZONTAL)
        ...
        photo_download_root_sizer = wx.StaticBoxSizer(
            wx.StaticBox(self.photo_download_page, wx.ID_ANY, _(u"\u7167\u7247\u4e0b\u8f7d\u5668")), wx.HORIZONTAL)
        ...
        grid_sizer_4 = wx.FlexGridSizer(11, 1, 0, 0)
        ...
        grid_sizer_4.Add((20, 25), 0, 0, 0)
        grid_sizer_4.Add(self.fucn_intr_ph_dl_text, 0, 0, 0)
        grid_sizer_4.Add(self.func_into_ph_dl_btn, 0, wx.ALIGN_CENTER | wx.EXPAND, 0)
        static_line_8 = wx.StaticLine(self.function_index_page, wx.ID_ANY)
        grid_sizer_4.Add(static_line_8, 0, wx.ALL | wx.EXPAND, 3)
        grid_sizer_4.Add(self.fucn_intr_ph_dl_text_copy, 0, 0, 0)
        grid_sizer_4.Add(self.func_into_doc_gen_btn, 0, wx.ALIGN_CENTER | wx.EXPAND, 0)
        static_line_18 = wx.StaticLine(self.function_index_page, wx.ID_ANY)
        grid_sizer_4.Add(static_line_18, 0, wx.ALL | wx.EXPAND, 3)
        ...
        photo_download_label = wx.StaticText(self.photo_download_page, wx.ID_ANY,
                                             _(u"\u76d1\u7ba1\u4e91\n\u7167\u7247\u4e0b\u8f7d\u5668"),
                                             style=wx.ALIGN_CENTER)
        ...
        label_1 = wx.StaticText(self.photo_download_page, wx.ID_ANY, _(u"\u4e0b\u8f7d\u8def\u5f84:"),
                                style=wx.ALIGN_CENTER)
        ...
        label_7 = wx.StaticText(self.doc_gen_page, wx.ID_ANY, _(u"\u73b0\u573a\u7b14\u5f55\u6a21\u677f:"),
                                style=wx.ALIGN_CENTER)
        ...
        label_9 = wx.StaticText(self.doc_gen_page, wx.ID_ANY,
                                _(u"\u4f01\u4e1a\u4fe1\u606f\u53ca\u6838\u67e5\u8bb0\u5f55\u8868:"),
                                style=wx.ALIGN_CENTER)
        ...
        label_12 = wx.StaticText(self.doc_gen_page, wx.ID_ANY, _(u"\u6838\u67e5\u7167\u7247\u5b58\u653e\u76ee\u5f55:"),
                                 style=wx.ALIGN_CENTER)
        ...
        label_10 = wx.StaticText(self.doc_gen_page, wx.ID_ANY, _(u"\u6587\u4e66\u751f\u6210\u6839\u76ee\u5f55:"),
                                 style=wx.ALIGN_CENTER)
        ...
        doc_gen_label_copy = wx.StaticText(self.doc_gen_page, wx.ID_ANY,
                                           _(u"\u76d1\u7ba1\u4e91\n\u6838\u67e5\u6587\u4e66\u751f\u6210\u5668"),
                                           style=wx.ALIGN_CENTER)
        ...
        label_11 = wx.StaticText(self.doc_gen_page, wx.ID_ANY, _(u"\u9009\u62e9\u6a21\u677f\u60c5\u51b5:"),
                                 style=wx.ALIGN_CENTER)
        ...
        doc_gen_right_side.Add((0, 0), 0, 0, 0)
        label_doc_gen_result = wx.StaticText(self.doc_gen_page, wx.ID_ANY, _(u"\u5904\u7406\u60c5\u51b5"),
                                             style=wx.ALIGN_CENTER)
    ...
    def choose_dg_ph_tpl_btn(self, event):  # wxGlade: MainFrame.<event_handler>
        dlg = wx.FileDialog(self, u"选择证据提取单模版", wildcard="docx files (*.docx)|*.docx",
                            style=wx.FD_OPEN | wx.FD_FILE_MUST_EXIST)
        if dlg.ShowModal() == wx.ID_OK:
    ...
    def hash_choose_file(self, event):  # wxGlade: MainFrame.<event_handler>
        print("Event handler 'hash_choose_file' not implemented!")
        event.Skip()

    def hash_choose_path(self, event):  # wxGlade: MainFrame.<event_handler>
        print("Event handler 'hash_choose_path' not implemented!")
        event.Skip()

    def hash_clear_resut(self, event):  # wxGlade: MainFrame.<event_handler>
        print("Event handler 'hash_clear_resut' not implemented!")
        event.Skip()

    def hash_copy_to_clipboard(self, event):  # wxGlade: MainFrame.<event_handler>
        print("Event handler 'hash_copy_to_clipboard' not implemented!")
        event.Skip()

    def hash_save_to_file(self, event):  # wxGlade: MainFrame.<event_handler>
        print("Event handler 'hash_save_to_file' not implemented!")
        event.Skip()

    def hash_stop_hasing(self, event):  # wxGlade: MainFrame.<event_handler>
        print("Event handler 'hash_stop_hasing' not implemented!")
        event.Skip()

    def func_goto_ph_dl_btn(self, event):  # wxGlade: MainFrame.<event_handler>
        btns = EvtHandler.FuncPageEventHandlers(self)
        btns.goto_ph_dl_page()
        del btns

    def func_goto_ins_dl_btn(self, event):  # wxGlade: MainFrame.<event_handler>
        btns = EvtHandler.FuncPageEventHandlers(self)
        btns.goto_ins_dl_page()
        del btns

    def func_goto_doc_gen_btn(self, event):  # wxGlade: MainFrame.<event_handler>
        btns = EvtHandler.FuncPageEventHandlers(self)
        btns.goto_doc_gen_page()
        del btns
